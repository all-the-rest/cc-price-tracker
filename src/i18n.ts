...
export const i18n = {
  de: {
    ...
    priceValueNote: "= {mult}× vom beworbenen Preis (ohne Gebühr)",
  ...
  en: {
    ...
    priceValueNote: "= {mult}× the advertised price (no fee)",
