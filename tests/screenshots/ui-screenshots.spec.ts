...
// unlesbar. Deshalb wird die gesamte Seite zusätzlich in Viewport-Höhen-Sektionen
// erfasst (Scroll-Schritte à 80 % der Viewport-Höhe → 20 % Überlappung, kein Lücke).
//
